object frmCancelaVenda: TfrmCancelaVenda
  Left = 1
  Top = 134
  ...
  object dsVenda: TDataSource
    DataSet = dmGerenciador.cdsVendas
    Left = 224
    Top = 24
  end
end
